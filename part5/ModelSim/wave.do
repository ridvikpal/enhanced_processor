...
add wave -noupdate -label carry_out /testbench/U1/U3/carry_out
add wave -noupdate -label Sum -radix hexadecimal -radixshowbase 0 /testbench/U1/U3/Sum
add wave -noupdate -label Z_out /testbench/U1/U3/Z_out
add wave -noupdate -label N_out /testbench/U1/U3/N_out
add wave -noupdate -label C_out /testbench/U1/U3/C_out
add wave -noupdate -label Imm /testbench/U1/U3/Imm
add wave -noupdate -label rX /testbench/U1/U3/rX
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {570898 ps} 0}
...
update
WaveRestoreZoom {463049 ps} {621141 ps}
